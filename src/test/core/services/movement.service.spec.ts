...
describe('MovementService', () => {
  ...
  describe('Manejo de transacciones financieras', () => {
    it('debe manejar múltiples depósitos consecutivos', (done) => {
      ...
      const req1 = httpMock.expectOne(`${environment.apiUrl}/transactions`);
      const req2 = httpMock.expectOne(`${environment.apiUrl}/transactions`);

      req1.flush({ ...mockMovement, amount: 100.00, balance: 1100.00 });
      req2.flush({ ...mockMovement, amount: 200.00, balance: 1300.00 });
    });
